...
class Product_package extends Product{
	...
	var	$back		=	'./product_detail_package.php?myParent=';
	var	$s_size		=	array("m"=>array("w"=>80,"h"=>80));
	...
	function renew(){
		...
		parent::renew();
		$this	->	back	=	"product_detail_package.php?myParent=".$this->myParent;		
