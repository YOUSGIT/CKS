        	...
        	<div class="crumb">
            	<div class="bt">
                    <ul>
                        ...
                        <li class="catalog"><a href="news_list.php">NEWS</a></li>
                        <li><?=$ret['title'];?></li>
            ...
            <div class="span-col">
              <div class="news">
              	<div class="news-detail">
                  	...
                  	<h1 class="pencil"><?=$ret['title'];?></h1>
                    <div class="date"><?=date('Y-m-d',strtotime($ret['dates']));?></div>
                  	<div class="news-detail">   

                    	<?php if(is_file(NEWS_Image.'s_'.$ret['image'])){?><span class="photo"><img src="<?=NEWS_Image.'s_'.$ret['image'];?>"  /></span><?php } ?>
						<?=stripslashes($ret['content']);?>
					</div>
                  </div>
               </div>
            </div>
