      ...
      <tr>
        ...
        <td class="right-panel-container">
                ...
                <div class="module-detail">
                	<ul class="detail-tag">
                        <li><a href="#" class="active">編輯新聞</a></li>                       
                    </ul>
                    ...
                    <input name="id" type="hidden" id="id" value="<?=$row['id'];?>" />                 	
                   	  <table width="100%" border="0" cellspacing="0" cellpadding="0" class="detail">
                          <tr>
                            <th width="100" align="right">新聞標題</th>
                            <td><input name="title" type="text" id="title" value="<?=$row['title'];?>" size="100" /></td>
                          </tr>
                          <tr>
                            <th align="right">新聞圖片</th>
                            <td><input type="file" name="news_image" id="news_image" /></td>
                          </tr>
                          <tr>
                            <th align="right">&nbsp;</th>
                            <td><span id="detail_image"><?php if(is_file(NEWS_Image.$row['image'])){?>
                            <a href="#doit=del&func=news&delid=<?=$row['id'];?>" onclick="delp('<?=NEWS_Image;?>','<?=$row['image'];?>')" class="delete"><span class="text">移除</span>
                            <img src="<?=NEWS_Image.$row['image'];?>"  class="image" /></a>
                            <?php }?></span></td>
                          </tr>
                          <tr>
                            <th align="right" valign="top">新聞內容</th>
